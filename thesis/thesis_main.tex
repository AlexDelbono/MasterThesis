...
\hypersetup{
    ...
    pdftitle   = {Consensus algorithm for a formation of Unmanned Aerial Vehicles},    				% title
...
\input{chapters/chapter-02/system_architecture.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Chapter 3
\chapter{Consensus node\label{chap:consensus_node}}
\input{chapters/chapter-03/consensus_node.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Chapter 4
\chapter{Simulation results\label{chap:simulation_results}}
\input{chapters/chapter-04/simulation_results.tex}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Chapter 5
\chapter{Experimental results\label{chap:experimental_results}}
\input{chapters/chapter-05/experimental_results.tex}
